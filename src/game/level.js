...
const LEVEL_DATA = [
    ...
    createLevel({
        id: 'e1m3-barracks',
        name: 'Episode 1: Guard Barracks',
        meta: { episode: 1, floor: 3, theme: 'barracks' },
        nextLevelId: 'e1m4-armory',
        metadata: {
            briefing: 'Fight through the guard quarters. Dogs patrol these halls.',
            primaryObjective: 'Clear the barracks and reach the armory lift.',
            bonusObjective: 'Search the bunks for hidden supplies.',
        },
        layout: [
            '####################',
            '#>......D..........#',
        ...
        entities: [
            { id: 'b-guard-1', type: 'guard', x: 5.5, y: 1.5, patrolPoints: [{ x: 5.5, y: 1.5 }, { x: 3.5, y: 3.5 }] },
            { id: 'b-guard-2', type: 'guard', x: 10.5, y: 3.5, patrolPoints: [{ x: 10.5, y: 3.5 }, { x: 7.5, y: 5.5 }] },
            { id: 'b-dog-1', type: 'dog', x: 14.5, y: 5.5, patrolPoints: [{ x: 14.5, y: 5.5 }, { x: 16.5, y: 1.5 }] },
            { id: 'b-dog-2', type: 'dog', x: 4.5, y: 9.5, patrolPoints: [{ x: 4.5, y: 9.5 }, { x: 8.5, y: 9.5 }] },
            { id: 'b-officer-1', type: 'officer', x: 12.5, y: 9.5, patrolPoints: [{ x: 12.5, y: 9.5 }, { x: 15.5, y: 11.5 }] },
            { id: 'b-guard-3', type: 'guard', x: 16.5, y: 13.5, patrolPoints: [{ x: 16.5, y: 13.5 }, { x: 12.5, y: 13.5 }] },
        ],
        pickups: [
            { id: 'b-ammo-1', type: 'ammo', x: 3.5, y: 1.5, amount: 8 },
            { id: 'b-medkit-1', type: 'medkit', x: 8.5, y: 5.5, amount: 15 },
            { id: 'b-food-1', type: 'food', x: 14.5, y: 7.5, amount: 10 },
            { id: 'b-ammo-2', type: 'ammo', x: 10.5, y: 11.5, amount: 10 },
            { id: 'b-treasure-1', type: 'treasure', x: 2.5, y: 11.5, amount: 1, value: 300, label: 'DOG TAGS' },
        ],
        props: [
            { id: 'b-table-1', type: 'table', x: 6.5, y: 3.5 },
            { id: 'b-barrel-1', type: 'barrel', x: 16.5, y: 7.5 },
            { id: 'b-skeleton-1', type: 'skeleton', x: 2.5, y: 9.5 },
        ],
        secrets: [
            { id: 'b-secret-1', x: 2.5, y: 7.5, title: 'HIDDEN BUNK', value: 175 },
        ],
        exit: { facing: 'east' },
    }),
    createLevel({
        id: 'e1m4-armory',
        name: 'Episode 1: Armory Wing',
        meta: { episode: 1, floor: 4, theme: 'armory' },
        nextLevelId: 'e1m5-prison',
        metadata: {
            briefing: 'The armory wing holds heavy weapons. Expect strong resistance.',
            primaryObjective: 'Secure the chaingun and advance to the prison block.',
            bonusObjective: 'Locate the hidden weapons cache.',
        },
        layout: [
            '##################',
            '#>....D....%...G.#',
        ...
        entities: [
            { id: 'a-guard-1', type: 'guard', x: 5.5, y: 1.5, patrolPoints: [{ x: 5.5, y: 1.5 }, { x: 8.5, y: 1.5 }] },
            { id: 'a-guard-2', type: 'guard', x: 12.5, y: 1.5, patrolPoints: [{ x: 12.5, y: 1.5 }, { x: 14.5, y: 3.5 }] },
            { id: 'a-officer-1', type: 'officer', x: 8.5, y: 5.5, patrolPoints: [{ x: 8.5, y: 5.5 }, { x: 5.5, y: 5.5 }] },
            { id: 'a-officer-2', type: 'officer', x: 10.5, y: 7.5, patrolPoints: [{ x: 10.5, y: 7.5 }, { x: 14.5, y: 7.5 }] },
            { id: 'a-commander-1', type: 'commander', x: 14.5, y: 11.5, patrolPoints: [{ x: 14.5, y: 11.5 }, { x: 10.5, y: 11.5 }] },
            { id: 'a-guard-3', type: 'guard', x: 3.5, y: 9.5, patrolPoints: [{ x: 3.5, y: 9.5 }, { x: 3.5, y: 7.5 }] },
            { id: 'a-dog-1', type: 'dog', x: 7.5, y: 9.5, patrolPoints: [{ x: 7.5, y: 9.5 }, { x: 9.5, y: 9.5 }] },
        ],
        pickups: [
            { id: 'a-ammo-1', type: 'ammo', x: 3.5, y: 1.5, amount: 10 },
            { id: 'a-chaingun', type: 'chaingun', x: 6.5, y: 7.5, amount: 1 },
            { id: 'a-medkit-1', type: 'medkit', x: 10.5, y: 5.5, amount: 20 },
            { id: 'a-armor-1', type: 'armor', x: 14.5, y: 1.5, amount: 50 },
            { id: 'a-gold-key', type: 'gold-key', x: 12.5, y: 9.5, amount: 1 },
            { id: 'a-treasure-1', type: 'treasure', x: 16.5, y: 1.5, amount: 1, value: 400, label: 'AMMO CRATE' },
            { id: 'a-ammo-2', type: 'ammo', x: 14.5, y: 9.5, amount: 12 },
        ],
        props: [
            { id: 'a-barrel-1', type: 'barrel', x: 4.5, y: 5.5 },
            { id: 'a-lamp-1', type: 'lamp', x: 8.5, y: 7.5 },
            { id: 'a-column-1', type: 'column', x: 12.5, y: 7.5 },
        ],
        secrets: [
            { id: 'a-secret-1', x: 16.5, y: 3.5, title: 'WEAPONS CACHE', value: 200 },
        ],
        exit: { facing: 'east' },
    }),
    createLevel({
        ...
        meta: { episode: 1, floor: 5, theme: 'prison' },
        nextLevelId: 'e1m6-command',
        metadata: {
            briefing: 'Navigate the prison cells. SS guards patrol heavily here.',
            primaryObjective: 'Fight through the prison and reach the command elevator.',
            bonusObjective: 'Free prisoners by finding all secrets.',
        },
        layout: [
            '####################',
            '#>......D..........#',
        ...
        entities: [
            { id: 'p-ss-1', type: 'officer', x: 6.5, y: 1.5, patrolPoints: [{ x: 6.5, y: 1.5 }, { x: 3.5, y: 3.5 }] },
            { id: 'p-ss-2', type: 'officer', x: 14.5, y: 3.5, patrolPoints: [{ x: 14.5, y: 3.5 }, { x: 16.5, y: 1.5 }] },
            { id: 'p-guard-1', type: 'guard', x: 8.5, y: 5.5, patrolPoints: [{ x: 8.5, y: 5.5 }, { x: 12.5, y: 5.5 }] },
            { id: 'p-guard-2', type: 'guard', x: 4.5, y: 7.5, patrolPoints: [{ x: 4.5, y: 7.5 }, { x: 8.5, y: 7.5 }] },
            { id: 'p-dog-1', type: 'dog', x: 10.5, y: 9.5, patrolPoints: [{ x: 10.5, y: 9.5 }, { x: 14.5, y: 7.5 }] },
            { id: 'p-officer-1', type: 'officer', x: 16.5, y: 11.5, patrolPoints: [{ x: 16.5, y: 11.5 }, { x: 12.5, y: 13.5 }] },
            { id: 'p-guard-3', type: 'guard', x: 6.5, y: 13.5, patrolPoints: [{ x: 6.5, y: 13.5 }, { x: 10.5, y: 13.5 }] },
        ],
        pickups: [
            { id: 'p-ammo-1', type: 'ammo', x: 3.5, y: 1.5, amount: 8 },
            { id: 'p-medkit-1', type: 'medkit', x: 10.5, y: 5.5, amount: 15 },
            { id: 'p-food-1', type: 'food', x: 16.5, y: 5.5, amount: 10 },
            { id: 'p-ammo-2', type: 'ammo', x: 8.5, y: 9.5, amount: 10 },
            { id: 'p-armor-1', type: 'armor', x: 2.5, y: 11.5, amount: 30 },
            { id: 'p-silver-key', type: 'silver-key', x: 14.5, y: 11.5, amount: 1 },
            { id: 'p-treasure-1', type: 'treasure', x: 18.5, y: 9.5, amount: 1, value: 350, label: 'PRISON DIARY' },
        ],
        props: [
            { id: 'p-skeleton-1', type: 'skeleton', x: 2.5, y: 3.5 },
            { id: 'p-blood-1', type: 'blood', x: 14.5, y: 9.5 },
            { id: 'p-barrel-1', type: 'barrel', x: 18.5, y: 7.5 },
        ],
        secrets: [
            { id: 'p-secret-1', x: 18.5, y: 11.5, title: 'PRISONER STASH', value: 200 },
        ],
        exit: { facing: 'east' },
    }),
    createLevel({
        id: 'e1m6-command',
        name: 'Episode 1: Command Deck',
        meta: {
            episode: 1,
            floor: 6,
            theme: 'command',
